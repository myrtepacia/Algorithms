...
function syncGreedyPanels(showOutput = false) {
  ...
  if (v==='activity'){ $('g-activity').style.display='block'; if (showOutput) $('g-activity-vis').style.display='block'; }
  if (v==='knapsack'){ $('g-knapsack').style.display='block'; if (showOutput) $('g-knap-vis').style.display='block'; }
  if (v==='egypt'){ $('g-egypt').style.display='block'; if (showOutput) $('g-egypt-vis').style.display='block'; }
  if (v==='jobseq'){ $('g-jobseq').style.display='block'; if (showOutput) $('g-job-vis').style.display='block'; }
  if (v==='huffman'){ $('g-huffman').style.display='block'; if (showOutput) $('g-huf-vis').style.display='block'; }
}
if (greedyAlgoSel) {
  greedyAlgoSel.addEventListener('change', ()=> syncGreedyPanels(false));
  syncGreedyPanels(false);
}
